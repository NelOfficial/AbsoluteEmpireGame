...
public class MovePoint : MonoBehaviour
{
    ...
    [SerializeField] private bool noAutoRegionTo;
    ...
    private void Fight(RegionManager fightRegion)
    {
        ...
        ReferencesManager.Instance.regionUI._currentTerrainThumbnail.sprite = newRegion.regionTerrain.icon;
    ...
    public void ConfirmFight()
    {
        ...
        {
            RegionManager annexedRegion = regionTo.GetComponent<RegionManager>();
