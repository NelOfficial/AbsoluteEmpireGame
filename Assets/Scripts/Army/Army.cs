...
public class Army : MonoBehaviour
{
    ...
    public void CreateUnit()
    {
        ...
        else
        {
            ...
            if (ReferencesManager.Instance.countryManager.currentCountry.money >= unit.moneyCost &&
                ReferencesManager.Instance.countryManager.currentCountry.recroots >= unit.recrootsCost &&
                ReferencesManager.Instance.countryManager.currentCountry.food >= unit.foodCost)
            {
