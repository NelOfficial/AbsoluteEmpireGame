...
//public class YandexSDKFixed : MonoBehaviour
//{
...
//    public static YandexSDKFixed instance;
...
//    public event Action<int> onRewardedAdError;
...
//        Time.timeScale = 0;
//#if UNITY_EDITOR
//        interstitialAdPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Assets/YandexSDKWebGLUnityPlugin-main/Prefab/InterstitialAd.prefab", typeof(GameObject));
...
//    {
//#if UNITY_EDITOR
//        rewardedAdPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Assets/YandexSDKWebGLUnityPlugin-main/Prefab/RewardedAd.prefab", typeof(GameObject));
